...
:::info[Indicação]
Se você quer aprendenr a programar. Pode iniciar com o material do Tecnólogo e depois seguir para o material de Arquitetura de Software.
:::
...
flowchart
  ...
  C([Arquitetura])
	...
	click A "puc/intro"
	click B "category/notas-de-estudo"
	click B1 "category/aws-skill-builder"
	click B2 "category/neovim"
  click C "category/arquitetura-de-software"
```
</center>
