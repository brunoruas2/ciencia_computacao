...
![Programa de cálculo da média de 5 valores em c\#](../img/25-algoritmo-logica-media-cs.png)
...
![Programa de resolução de uma equação do segundo grau.](../img/26-algoritmo-equacao-grau2.png)
